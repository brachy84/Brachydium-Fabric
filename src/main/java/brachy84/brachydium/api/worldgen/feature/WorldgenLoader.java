...
public class WorldgenLoader extends SinglePreparationResourceReloader<Map<String, List<Pair<Identifier, ConfiguredFeature<?, ?>>>>> implements IdentifiableResourceReloadListener {

    private static final Identifier LISTENER_ID = new Identifier(Brachydium.MOD_ID, "worldgen_loader");
    private static final Logger LOGGER = LoggerFactory.getLogger(WorldgenLoader.class);
