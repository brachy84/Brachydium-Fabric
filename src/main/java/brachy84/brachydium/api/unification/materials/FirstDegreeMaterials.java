package brachy84.brachydium.api.unification.materials;
...
import static brachy84.brachydium.api.unification.material.info.MaterialIconSet.*;
...
public class FirstDegreeMaterials {
    ...
    public static void register() {
        ...
        AnnealedCopper = new Material.Builder(252, "annealed_copper")
                ...
                .components(Copper, 1)
                .cableProperties(ByValues.V[2], 1, 1)
                .build();
        ...
        Cupronickel = new Material.Builder(274, "cupronickel")
                ...
                .itemPipeProperties(2048, 1)
                .cableProperties(ByValues.V[1], 1, 1)
                .build();
        ...
        Electrum = new Material.Builder(277, "electrum")
                ...
                .cableProperties(ByValues.V[3], 3, 2)
                .build();
        ...
        Kanthal = new Material.Builder(288, "kanthal")
                ...
                .cableProperties(ByValues.V[3], 4, 3)
                .blastTemp(1800)
                .build();
        ...
        Nichrome = new Material.Builder(294, "nichrome")
                ...
                .cableProperties(ByValues.V[4], 4, 4)
                .blastTemp(2700)
                .build();
        ...
        NiobiumNitride = new Material.Builder(295, "niobium_nitride")
                ...
                .cableProperties(ByValues.V[6], 1, 1)
                .blastTemp(2573)
                .build();
        ...
        NiobiumTitanium = new Material.Builder(296, "niobium_titanium")
                ...
                .cableProperties(ByValues.V[6], 4, 2)
                .blastTemp(4500)
                .build();
        ...
        DiamericiumTitanium = new Material.Builder(317, "diamericium_titanium")
                ...
                .cableProperties(ByValues.V[10], 8, 16)
                .blastTemp(10400)
                .build();
        ...
        Steel = new Material.Builder(324, "steel")
                ...
                .cableProperties(ByValues.V[4], 2, 2)
                .blastTemp(1000)
                .build();
        ...
        VanadiumGallium = new Material.Builder(334, "vanadium_gallium")
                ...
                .cableProperties(ByValues.V[7], 4, 2)
                .blastTemp(4500)
                .build();
        ...
        YttriumBariumCuprate = new Material.Builder(338, "yttrium_barium_cuprate")
                ...
                .cableProperties(ByValues.V[8], 4, 4)
                .blastTemp(4500)
                .build();
        ...
        Graphene = new Material.Builder(342, "graphene")
                ...
                .components(Carbon, 1)
                .cableProperties(ByValues.V[5], 1, 1)
                .build();
        ...
        ManganesePhosphide = new Material.Builder(424, "manganese_phosphide")
                ...
                .cableProperties(ByValues.V[ByValues.LV], 2, 0, true)
                .blastTemp(1200)
                .build();
        ...
        MagnesiumDiboride = new Material.Builder(425, "magnesium_diboride")
                ...
                .cableProperties(ByValues.V[ByValues.MV], 4, 0, true)
                .blastTemp(2500)
                .build();
        ...
        MercuryBariumCalciumCuprate = new Material.Builder(426, "mercury_barium_calcium_cuprate")
                ...
                .cableProperties(ByValues.V[ByValues.HV], 4, 0, true)
                .blastTemp(3300)
                .build();
        ...
        UraniumTriplatinum = new Material.Builder(427, "uranium_triplatinum")
                ...
                .cableProperties(ByValues.V[ByValues.EV], 6, 0, true)
                .blastTemp(4400)
                .build()
        ...
        SamariumIronArsenicOxide = new Material.Builder(428, "samarium_iron_arsenic_oxide")
                ...
                .cableProperties(ByValues.V[ByValues.IV], 6, 0, true)
                .blastTemp(5200)
                .build();
        ...
        IndiumTinBariumTitaniumCuprate = new Material.Builder(429, "indium_tin_barium_titanium_cuprate")
                ...
                .cableProperties(ByValues.V[ByValues.LuV], 8, 0, true)
                .blastTemp(6000)
                .build();
        ...
        UraniumRhodiumDinaquadide = new Material.Builder(430, "uranium_rhodium_dinaquadide")
                ...
                .cableProperties(ByValues.V[ByValues.ZPM], 8, 0, true)
                .blastTemp(9000)
                .build()
        ...
        EnrichedNaquadahTriniumEuropiumDuranide = new Material.Builder(431, "enriched_naquadah_trinium_europium_duranide")
                ...
                .cableProperties(ByValues.V[ByValues.UV], 16, 0, true)
                .blastTemp(9900)
                .build();
        ...
        RutheniumTriniumAmericiumNeutronate = new Material.Builder(432, "ruthenium_trinium_americium_neutronate")
                ...
                .cableProperties(ByValues.V[ByValues.MAX], 24, 0, true)
                .blastTemp(10800)
                .build();
    }
}
