...
import brachy84.brachydium.api.unification.material.Material.FluidType;
...
public class ElementMaterials {
    ...
    public static void register() {
        ...
        Aluminium = new Material.Builder(2, "aluminium")
                ...
                .cableProperties(ByValues.V[4], 1, 1)
        ...
        Cobalt = new Material.Builder(23, "cobalt")
                ...
                .cableProperties(ByValues.V[1], 2, 2)
        ...
        Copper = new Material.Builder(25, "copper")
                ...
                .element(Elements.Cu)
                .cableProperties(ByValues.V[2], 1, 2)
        ...
        Europium = new Material.Builder(33, "europium")
                ...
                .element(Elements.Eu)
                .cableProperties(ByValues.V[ByValues.UHV], 2, 32)
        ...
        Gold = new Material.Builder(41, "gold")
                ...
                .element(Elements.Au)
                .cableProperties(ByValues.V[3], 2, 2)
        ...
        Iron = new Material.Builder(51, "iron")
                ...
                .cableProperties(ByValues.V[2], 2, 3)
                .build();
        ...
        Nickel = new Material.Builder(69, "nickel")
                ...
                .element(Elements.Ni)
                .cableProperties(ByValues.V[2], 3, 3)
        ...
        Osmium = new Material.Builder(75, "osmium")
                ...
                .cableProperties(ByValues.V[5], 4, 2)
        ...
        Palladium = new Material.Builder(77, "palladium")
                ...
                .cableProperties(ByValues.V[5], 2, 1)
                .blastTemp(1228)
                .build();
        ...
        Silver = new Material.Builder(100, "silver")
                ...
                .element(Elements.Ag)
                .cableProperties(ByValues.V[3], 1, 1)
                .build();
        ...
        Titanium = new Material.Builder(113, "titanium") // todo Ore?
                ...
                .cableProperties(ByValues.V[4], 4, 2)
        ...
        Tungsten = new Material.Builder(115, "tungsten")
                ...
                .element(Elements.W)
                .toolStats(7.0f, 3.0f, 2560, 21)
                .cableProperties(ByValues.V[5], 2, 2)
        ...
        Naquadah = new Material.Builder(124, "naquadah")
                ...
                .cableProperties(ByValues.V[7], 2, 2)
        ...
        Duranium = new Material.Builder(129, "duranium")
                ...
                .cableProperties(ByValues.V[8], 1, 8)
