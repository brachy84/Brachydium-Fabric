...
import brachy84.brachydium.api.unification.material.info.MaterialFlags;
import brachy84.brachydium.api.unification.material.info.MaterialIconSet;
import brachy84.brachydium.api.unification.material.properties.*;
import brachy84.brachydium.api.unification.stack.MaterialStack;
import brachy84.brachydium.api.util.SmallDigits;
...
public class Material implements Comparable<Material> {
    ...
    public static class Builder {
        ...
        public Builder color(int red, int green, int blue) {
            ...
            this.materialInfo.color = Color.of(red, green, blue).asInt();
            return this;
        }
