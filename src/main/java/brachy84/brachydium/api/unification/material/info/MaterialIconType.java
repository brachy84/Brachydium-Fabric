package brachy84.brachydium.api.unification.material.info;
...
public class MaterialIconType {
    ...
    public final int id;
    public final ColorProvider defaultColorProvider;

    public MaterialIconType(String name, ColorProvider colorProvider) {
        ...
        this.id = idCounter++;
        this.defaultColorProvider = colorProvider;
        ICON_TYPES.put(this.name, this);
    }

    public MaterialIconType(String name) {
        this(name, ColorProvider.onlyLayer(0));
    }

    public Identifier getBlockPath(MaterialIconSet materialIconSet) {
        return new Identifier(Brachydium.MOD_ID, "blocks/material_sets/" + materialIconSet.name + "/" + this.name);
    }

    public Identifier getItemModelPath(MaterialIconSet materialIconSet) {
        return new Identifier(Brachydium.MOD_ID, "material_sets/" + materialIconSet.name + "/" + this.name);
    }

    public Identifier getItemOverlayPath(MaterialIconSet materialIconSet) {
        return new Identifier(Brachydium.MOD_ID, "material_sets/" + materialIconSet.name + "/" + this.name + "_overlay");
    }
